...
public class Startup : IWebStartup
{
    public virtual void ConfigureServices(IConfiguration configuration, IWebHostEnvironment environment, IServiceCollection services)
    {
        ...
        services.AddScoped<Gateway.Embeddings.IEmbeddingClientAdapter, Gateway.Embeddings.OpenAiEmbeddingClientAdapter>();
        services.AddScoped<Gateway.Embeddings.IEmbeddingClientAdapter, Gateway.Embeddings.OllamaEmbeddingClientAdapter>();
        services.AddScoped<Gateway.Embeddings.IEmbeddingProviderAdapter, Gateway.Embeddings.OpenAiEmbeddingProviderAdapter>();
        services.AddScoped<Gateway.Embeddings.IEmbeddingProviderAdapter, Gateway.Embeddings.OllamaEmbeddingProviderAdapter>();
        services.AddScoped<Gateway.Embeddings.IEmbeddingGatewayService, Gateway.Embeddings.EmbeddingGatewayService>();
        services.AddScoped<Gateway.Chat.IChatRequestDecoder, Gateway.Chat.OpenAiChatRequestDecoder>();
        services.AddScoped<Gateway.Chat.IChatRequestDecoder, Gateway.Chat.OpenAiResponsesRequestDecoder>();
        services.AddScoped<Gateway.Chat.IChatRequestDecoder, Gateway.Chat.OllamaChatRequestDecoder>();
        services.AddScoped<Gateway.Chat.IChatRequestDecoder, Gateway.Chat.AnthropicChatRequestDecoder>();
        services.AddScoped<Gateway.Chat.IChatProviderRequestAdapter, Gateway.Chat.OpenAiChatProviderRequestAdapter>();
        services.AddScoped<Gateway.Chat.IChatProviderRequestAdapter, Gateway.Chat.OpenAiResponsesProviderRequestAdapter>();
        services.AddScoped<Gateway.Chat.IChatProviderRequestAdapter, Gateway.Chat.OllamaChatProviderRequestAdapter>();
        services.AddScoped<Gateway.Chat.IChatRequestCompiler, Gateway.Chat.ChatRequestCompiler>();
        services.AddScoped<Gateway.Chat.IChatProviderResponseDecoder, Gateway.Chat.OpenAiChatProviderResponseDecoder>();
        services.AddScoped<Gateway.Chat.IChatProviderResponseDecoder, Gateway.Chat.OpenAiResponsesProviderResponseDecoder>();
        services.AddScoped<Gateway.Chat.IChatProviderResponseDecoder, Gateway.Chat.OllamaChatProviderResponseDecoder>();
        services.AddScoped<Gateway.Chat.IChatClientResponseWriter, Gateway.Chat.OpenAiChatClientResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatClientResponseWriter, Gateway.Chat.OpenAiResponsesClientResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatClientResponseWriter, Gateway.Chat.OllamaChatClientResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatClientResponseWriter, Gateway.Chat.AnthropicChatClientResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatCrossDialectResponseWriter, Gateway.Chat.ChatCrossDialectResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatWireResponseWriter, Gateway.Chat.OpenAiChatWireResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatWireResponseWriter, Gateway.Chat.OpenAiResponsesWireResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatWireResponseWriter, Gateway.Chat.OllamaChatWireResponseWriter>();
        services.AddScoped<Gateway.Chat.IChatResponseDispatcher, Gateway.Chat.ChatResponseDispatcher>();
